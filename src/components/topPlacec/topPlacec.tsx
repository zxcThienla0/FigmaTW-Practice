...
export default function topPlacec() {
    return (
        <section className="mt-35 max-w-316 m-auto lato-regular max-xl:px-4 mb-32">
            <p className="text-[35px] text-black ">Today top places to visit</p>
            <div className="w-63.5 h-0.75 bg-[#006DFE]"></div>
            <div className="mt-13.5 grid xl:grid-cols-3 gap-14 max-xl:grid-cols-2 justify-items-center max-lg:grid-cols-1">
                {cardData.map((card, index) => (
                    <a href="!#" className="relative FixAdaptive flex flex-col justify-between col-span-1" key={index}>
